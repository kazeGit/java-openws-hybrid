...
public class FileBackedHttpResource extends HttpResource {
    ...
    public InputStream getInputStream() throws ResourceException {
        ...
        try {
            ...
            final HttpResponse httpResponse = super.getResource(getMethod);

            ByteArrayOutputStream baos = new ByteArrayOutputStream();
            org.apache.commons.io.IOUtils.copy(httpResponse.getEntity().getContent(), baos);
            byte[] bytes = baos.toByteArray();

            saveToResourceFile(bytes);
